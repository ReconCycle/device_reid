...
class RotationModel(pl.LightningModule):
    ...
    def forward(self, sample, res_sample):
        ...
        x = torch.cat((x1, x2), 0) # concatenate
    ...
    def training_step(self, batch, batch_idx):
        ...
        loss = torch.nn.MSELoss()(logits, angle)

        # loss = F.nll_loss(logits, label) # TODO: change this.

        # preds = torch.argmax(logits, dim=1) # TODO: change this.
        # acc = self.accuracy(preds, label) # TODO: change this.
